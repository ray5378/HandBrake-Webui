...
function Transcode() {
  ...
  const fetchData = async () => {
    try {
      const [filesRes, presetsRes] = await Promise.all([
        api.get('/files'),
        api.get('/presets')
      ]);
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 bg-dark-700 rounded-lg">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setSettings({ ...settings, audioBitrate: parseInt(e.target.value) })}
                      className="input"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setSettings({ ...settings, audioChannels: parseInt(e.target.value) })}
                      className="input"
                    >
